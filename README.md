...
git clone https://github.com/YOUR_USERNAME/tts-asset-extractor.gitcd tts-asset-extractor
...
Usage
Run the script from your terminal, passing the path to your TTS JSON save file.
